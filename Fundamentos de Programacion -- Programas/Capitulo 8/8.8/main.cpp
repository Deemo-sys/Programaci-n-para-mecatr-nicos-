...
typedef struct      /* Declaracion de la estructuradomicilio. */
{
    char cal[20];         /* Calle. */
    int num;              /* Numero. */
    char col[20];         /* Colonia. */
...
/* La funcion F3 se utiliza para generar el nombre y teléfono de todos los
pacientes que tuvieron una condicion de ingreso de maxima gravedad (5). */
{
    int I;
