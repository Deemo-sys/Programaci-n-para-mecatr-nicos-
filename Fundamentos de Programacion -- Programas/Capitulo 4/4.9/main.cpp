...
/* Paso de una funcion como parametros por referencia. */
...
dependiendo de cual sea esta, llama la funcion Suma o Resta. */
{
    int RES;
...
R1 = Control(Resta, 10, 4);  /* Se pasa como parametro la funcion Resta. */
printf("\nResultado 1: %d", R1);
printf("\nResultado 2: %d", R2);
}
