...
problemas se utilizan unicamente con el objeto de que el lector
puede observar la forma en que se aplican. */
...
void main(void)
{
    ...
    while (CAL != -1)
    {
        Rango(CAL);  /*Llamada a la funcion Rango. Se para un parametro
                       por valor. */
