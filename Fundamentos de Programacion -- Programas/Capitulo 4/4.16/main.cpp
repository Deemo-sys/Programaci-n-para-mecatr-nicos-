...
temperaturas en el exterior en un periodo de 24 horas. Calcula
el promedio del dia y las temperaturas maximas y minima con la hora en la
que se registraron. */
...
int HMAX;
int HMIN;
/* Variables globales. ACT se utiliza para acumalar las temperaturas,
...
inicializa con el valor muy alto para que el primer valor ingresado
