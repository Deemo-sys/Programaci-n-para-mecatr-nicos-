...
void main(void)
{
        ...
        pudo abrir. */
    {
        ...
        while (res)
        {
            ...
            if (res)
            fputs("\n", ar);
            /* Se indica un salto de linea, excepto en la ultima cadena. Si no se
            hiciera esta indicacion, la funcion fputs pagarias las cadenas y luego
            tendriamos dificultades en el momento de leerlas. Por otra parte, si
            realizaramos este salto de linea al final de la ultima
