...
determina el número de letras minusculas y mayusculas que hay en el archivo. */
...
void main(void)
{
    ...
    {
        minymay(ar);
        /* Se llama a la función minymay. Se pasa el archivo ar como parametro. */
    fclose(ar);
    }
    else
...
/* Esta funcion cuenta el numero de minúsculas y mayusculas que hay en el
archivo arc. */
{
    int min = 0, may = 0;
    char p;
