...
void main(void)
{
    ...
    while (TAM>MAX || TAM<1); /* Se verifica que el tamano del arreglo sea
    correcto. */
...
elementos E en el arreglo unidimensional A de T elementos. Si se
encuentre el elemento, la funcion regresa la posicion correspondiente.
