...
void Mod0(int [][10], int, int);
void Mod1(int [][10], int);         /* Prototipos de funciones. */
void Mod2(int [][10], int, int);
...
correspondientes para resolver en problema. */
{
    int I;
    for (I=0; I<N; I++)
        switch (I%3)
...
/* Esta funcion obtiene el resultado de la produstoria. */
{
    int I;
    float PRO = 1.0;
    for (I=N; I<M; I++)
