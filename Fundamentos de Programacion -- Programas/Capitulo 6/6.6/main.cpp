...
void main(void)
{
    ...
    while (F > MAX || F < 1); /* Se verifica que el n�mero de filas sea corecto. */
    do
    {
        printf("Ingrese el numero de columnas: ");
        scanf("%d, &C");
    }
    while (C > MAX || C < 1); /* Se veridica que el numero de columnas sea correcto. */
...
/* La funcion Lectura se utiliza para leer un arreglo bidimensional del tipo
