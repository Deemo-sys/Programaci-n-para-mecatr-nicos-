...
void Lectuta (float A[][MES][A�O], int C, int P)
/* Esta funcion se utiliza para leer un arreglo tridimensional de tipo real de
F filas, C columnas y P planos de profuncidad. */
{
    int K, I, J;
    for (K=0; K<P; K++)
        for (I=0; I<F; I++)
...
de precipitacion pluvial en los ultimos 10 años. Escribe el registro
correspondiente. */
{
    int I, K, J, EMAY = -1;
    float ELLU = -1.0, SUM;
...
de lluvias en el ultimo año. Escribe ademas el registro correspondiente. */
{
    int I, J, EMEN;
    float ELLU = 1000, SUM;
    for (I=0; I<F; I++)
