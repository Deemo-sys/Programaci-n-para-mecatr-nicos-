...
void main(void)
{
    int (MA[MAX][MAX], MB[MAX][MAX], int [][MAX][MAX];
...
/* La funcion Lectura se utiliza para leer un arreglo biudimensional entero de F
filas y C columnas. */
{
    int I, J;
    for (I=0; I<C; J++)
...
void Suma(int M1[][MAX], int M2[][MAX], int F, int C)
/* La funcion Suma se utiliza para sumar los arreglos y almacenar el resultado
en el tercer arreglo bidimensional. */
{
    int I, J;
    for (I=0; I<C; J++)
